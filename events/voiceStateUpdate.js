 ...
 * This function manages voice channel events and tracking using the improved voice_recovery schema.
 *
...
module.exports = {
  ...
  async execute(oldState, newState) {
    try {
      ...
      // (Optional) You can add mute/deafen/streaming tracking here if desired
