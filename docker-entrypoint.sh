...
export NEWUSER_BEEN_IN_SERVER_BEFORE_ROLE_ID=$(bws secret get 19b8fe6d-d381-41e7-8e27-b3ef0013788a 2>/dev/null | jq -r '.value')
export NEWUSER_PERMISSION_DIFF_ROLE_ID=$(bws secret get 623916e5-3bb3-44b4-b5cc-b3ef00139217 2>/dev/null | jq -r '.value')
